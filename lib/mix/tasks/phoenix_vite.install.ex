  ...
  with_igniter do
    ...
    def igniter(igniter) do
      ...
      igniter =
        ...
        |> PhoenixVite.Igniter.update_generator_static_assets(web_module, endpoint)
        ...
        |> PhoenixVite.Igniter.add_phoenix_vite_plug_import(endpoint)
        |> PhoenixVite.Igniter.add_favicon_plug(endpoint)
